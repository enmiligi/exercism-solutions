...
def check_phone_number:
  capture("(?<phone>\\(\\+[0-9]{2}\\) [0-9]{3}-[0-9]{3}-[0-9]{3})|(?<incorrect>[0-9-]+)"; "")
   | 
    if .phone then
      "Thanks! Your phone number is OK."
    else
      "Oops, it seems like I can't reach out to \(.incorrect)."
    end
;
